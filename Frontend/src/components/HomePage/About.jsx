    ...
    <>
      ...
      <div className="pt-20 bg-gradient-to-b from-[#8157c9] to-white">
        <section className="bg-gradient-to-b from-[#8157c9] to-white py-28 px-6 relative ">
          ...
          <div className="max-w-3xl mx-auto z-10 relative text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-white tracking-widest mb-6">
              Z PRINCESS SAFFRON
            </h1>
            <p className="text-lg text-gray-500 tracking-widest leading-relaxed">
              At the crossroads of ancient heritage and modern purity, Z
              PRINCESS SAFFRON embodies the golden promise of authenticity.
            </p>
          </div>
        </section>
      </div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-20">
          <div className="text-center max-w-4xl">
            <h2 className="text-3xl font-semibold text-black uppercase tracking-widest mb-4">
              Who We Are
            </h2>
            <p className="text-gray-500 leading-loose">
              ...
              proudly launched by <strong>HeyRam Infrastructure</strong>, an IT
              services, web development, and digital marketing company led by{" "}
              <strong>Managing Director Raja K</strong>. With deep roots in
              innovation and quality, HeyRam Infrastructure envisioned a brand
              that brings the richness of saffron to the world with modern
              integrity and ancient reverence.
              <br />
              <br />
              Our journey blends the digital future with age-old agricultural
              heritage. Every strand of saffron we offer is a symbol of luxury,
              purity, and authenticity—sourced directly from the highlands of
              Kashmir and presented to you with meticulous care and quality
              assurance.
            </p>
          </div>
        </div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-20">
          <div className="text-center max-w-4xl">
            ...
            <p className="text-gray-500 leading-loose">
              We aren’t just merchants of saffron—we’re curators of a legacy.
              Each strand tells a story from high Himalayan valleys and
              sun-kissed Spanish fields. With every harvest, we preserve a piece
              of heritage, transforming kitchens, ceremonies, and lives.
            </p>
          </div>
          <div className="w-full grid md:grid-cols-3 gap-8">
            <div className="bg-white shadow-xl p-6 rounded-xl text-center">
              <h3 className="text-xl font-normal tracking-wider uppercase text-black mb-2">
                Origin-Based Sourcing
              </h3>
              <p className="text-sm text-gray-600">
                Direct partnerships with farms in Kashmir, Iran, and Spain
                ensure true traceability and freshness.
              </p>
            </div>
            <div className="bg-white shadow-xl p-6 rounded-xl text-center">
              <h3 className="text-xl font-normal tracking-wider uppercase text-black mb-2">
              ...
              <p className="text-sm text-gray-600">
                Each batch is tested for purity, aroma, and color strength
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 grid md:grid-cols-2 items-center gap-16">
          ...
          <div>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              saffron enriches every moment. We're proud to redefine
              saffron—from commodity to craft.
            </p>
      ...
      <section className="bg-white py-24 text-center">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-2xl font-semibold text-yellow-800 uppercase tracking-widest mb-4">
            Signature Quote
          </h2>
